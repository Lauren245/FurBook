...
document.addEventListener('submit', function(){
    ...
    console.log("appointment date = " + JSON.stringify(date));
    console.log("appointment date Locale = " + date.toLocaleString());
    apptArray.push(createAppointment(
        createOwner('New Person', '123-455-6354'),
        createPet('Buddy', 'poodle', 2),
        createService('nail trim', 'basic grooming'),
        createDayAndTime(date)
    ));
outputArray()
})
